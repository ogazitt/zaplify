...
namespace BuiltSteady.Zaplify.Shared.Entities
{
    ...
    public class UserConstants
    {
        ...
        public static string ConstantsVersion { get { return "2012-05-07"; } }
        ...
        public static List<ItemType> DefaultItemTypes()
        {
            ...
            // create Task
            itemTypes.Add(itemType = new ItemType() { ID = SystemItemTypes.Task, Name = "Task", UserID = SystemUsers.User, Fields = new List<Field>() });
            ...
            itemType.Fields.Add(new Field() { ID = new Guid("00000000-0000-0000-0000-000000000014"), FieldType = FieldTypes.DateTime, Name = FieldNames.ReminderDate, DisplayName = "Reminder", DisplayType = DisplayTypes.DateTimePicker, ItemTypeID = SystemItemTypes.Task, IsPrimary = false, SortOrder = 4 });
            ...
            // create Location
            itemTypes.Add(itemType = new ItemType() { ID = SystemItemTypes.Location, Name = "Location", UserID = SystemUsers.User, Icon = "location.png", Fields = new List<Field>() });
            ...
            // create Contact
            itemTypes.Add(itemType = new ItemType() { ID = SystemItemTypes.Contact, Name = "Contact", UserID = SystemUsers.User, Icon = "contact.png", Fields = new List<Field>() });
            ...
            itemType.Fields.Add(new Field() { ID = new Guid("00000000-0000-0000-0000-000000000038"), FieldType = FieldTypes.TagIDs, Name = FieldNames.ItemTags, DisplayName = "Tags", DisplayType = DisplayTypes.TagList, ItemTypeID = SystemItemTypes.Contact, IsPrimary = false, SortOrder = 8 });
            ...
            // create ListItem
            itemTypes.Add(itemType = new ItemType() { ID = SystemItemTypes.ListItem, Name = "List Item", UserID = SystemUsers.User, Fields = new List<Field>() });
            ...
            // create ShoppingItem
            itemTypes.Add(itemType = new ItemType() { ID = SystemItemTypes.ShoppingItem, Name = "Shopping Item", UserID = SystemUsers.User, Fields = new List<Field>() });
            ...
            itemType.Fields.Add(new Field() { ID = new Guid("00000000-0000-0000-0000-000000000057"), FieldType = FieldTypes.Url, Name = FieldNames.Picture, DisplayName = "Picture", DisplayType = DisplayTypes.Hidden /* TODO: DisplayTypes.ImageUrl */, ItemTypeID = SystemItemTypes.ShoppingItem, IsPrimary = false, SortOrder = 7 });
